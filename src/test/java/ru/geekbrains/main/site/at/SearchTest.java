...
public class SearchTest extends BaseTest {
    ...
    @ParameterizedTest
    @MethodSource("pageGenerator1")
    public void searchTabTest(String getCount) {
        new SearchTab(driver)
                .checkCount(getCount)
                .checkTab(getCount);
    }
    public static Stream<String> pageGenerator1() {
        return Stream.of("professions", "courses", "webinars", "blogs", "forums", "tests");
    }
